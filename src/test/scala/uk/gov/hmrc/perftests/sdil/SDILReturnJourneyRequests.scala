...
import uk.gov.hmrc.perftests.sdil.SDILReturnsRequests.{getAddSmallProducerPage, getBroughtIntoUKFromSmallProducersPage, getBroughtIntoUKPage, getCheckYourAnswersPage, getClaimCreditsForExportsPage, getClaimCreditsForLostDamagedPage, getExemptionsForSmallProducersPage, getHowManyBroughtIntoUKFromSmallProducersPage, getHowManyBroughtIntoUKPage, getHowManyCreditsForExportsPage, getHowManyCreditsForLostDamagedPage, getHowManyOwnBrandsPackagedAtOwnSitesPage, getHowManyPackagedAsContractPackerPage, getOwnBrandsPackagedAtOwnSitesPage, getPackAtBusinessAddressChangePage, getPackagedAsContractPackerPage, getProductionSiteDetailsPage, getReturnChangeRegistrationPage, getReturnSentPage, getSecondaryWarehouseDetailsPage, getSmallProducerDetailsPage, postAddSmallProducerPage, postBroughtIntoUKFromSmallProducersPage, postBroughtIntoUKPage, postCheckYourAnswersPage, postClaimCreditsForExportsPage, postClaimCreditsForLostDamagedPage, postExemptionsForSmallProducersPage, postHowManyBroughtIntoUKFromSmallProducersPage, postHowManyBroughtIntoUKPage, postHowManyCreditsForExportsPage, postHowManyCreditsForLostDamagedPage, postHowManyOwnBrandsPackagedAtOwnSitesPage, postHowManyPackagedAsContractPackerPage, postOwnBrandsPackagedAtOwnSitesPage, postPackAtBusinessAddressChangePage, postPackagedAsContractPackerPage, postProductionSiteDetailsPage, postReturnChangeRegistrationPage, postSecondaryWarehouseDetailsPage, postSmallProducerDetailsPage, redirectToBrandsPackagedAtOwnSitesPage}
import uk.gov.hmrc.perftests.sdil.SetupRequests.{resetPending, resetRegistrations, resetReturns, resetReturnsUserAnswers, sdilReturnsCollectionReset}
