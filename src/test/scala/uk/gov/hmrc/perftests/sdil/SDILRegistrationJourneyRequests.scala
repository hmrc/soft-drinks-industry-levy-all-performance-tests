...
//    resetReturnsUserAnswers(),
  ...
  val sdilRegisterAnswerYesToAllForLargeProducerJourneyRequests: Seq[HttpRequestBuilder] =
    sdilRegisterAnswerYesToAllForGivenProducerTypeJourneyRequests("large")
  val sdilRegisterAnswerYesToAllForSmallProducerJourneyRequests: Seq[HttpRequestBuilder] =
    sdilRegisterAnswerYesToAllForGivenProducerTypeJourneyRequests("small")
  val sdilRegisterAnswerYesToAllForNoneProducerJourneyRequests: Seq[HttpRequestBuilder]  =
    sdilRegisterAnswerYesToAllForGivenProducerTypeJourneyRequests("none")
