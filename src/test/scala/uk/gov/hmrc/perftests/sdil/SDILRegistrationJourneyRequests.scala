...
trait SDILRegistrationJourneyRequests {
  ...
  def sdilRegisterAnswerYesToAllForGivenProducerTypeJourneyRequests(producerType: String): Seq[HttpRequestBuilder] = {
    ...
    Seq(
      ...
      postPageRedirectToAddressLookup("packaging-site-details", "true", "/packing-site-details"),
      getAddressRampOffPage("/packaging-site-details"),
      getPage ("packaging-site-details"),
      postPage("packaging-site-details", "false", "/ask-secondary-warehouses"),
      getPage("ask-secondary-warehouses"),
      postPageRedirectToAddressLookup("ask-secondary-warehouses", "true", "/warehouses"),
      getAddressRampOffPage("/warehouses"),
      getPage("warehouses"),
      postPage("warehouses", "false", "/contact-details"),
